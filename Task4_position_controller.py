...
class Position():
	...
	if not np.any(self.currentloc):
        ...
        if self.ranges[3] < 1 and self.ranges[3] > 0.3:
        ...
        elif self.ranges[0] < 1 and self.ranges[0] > 0.3:
            if self.avoid_flag == 0:
                self.avoid_flag = 1
                self.prev_values = np.array([0, 0, 0])
        ...
        elif self.ranges[1] < 1 and self.ranges[1] > 0.3:
            if self.avoid_flag == 0:
                self.avoid_flag = 1
                self.prev_values = np.array([0, 0, 0])
        ...
        elif self.ranges[2] < 1 and self.ranges[2] > 0.3:
            if self.avoid_flag == 0:
                self.avoid_flag = 1
                self.prev_values = np.array([0, 0, 0])
