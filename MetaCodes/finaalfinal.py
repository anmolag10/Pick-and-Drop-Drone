...
class Position():
    ...
    def delivery(self):
        ...
        if self.ranges[3] < 4.5 and self.ranges[3] > 0.4:
        ...
        elif self.ranges[0] < 4.5 and self.ranges[0] > 0.4:
            print(3)
            if self.flag == 0:
                self.flag = 1
            ...
            self.waypoint[0] = self.currentlocxy[0] - 2
